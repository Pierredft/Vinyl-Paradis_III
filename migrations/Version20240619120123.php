 ...
 */
final class Version20240619120123 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE orders_details ADD orders_id INT DEFAULT NULL, ADD disque_id INT DEFAULT NULL');
        ...
        $this->addSql('CREATE INDEX IDX_835379F191161FE8 ON orders_details (disque_id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_835379F191161FE8 ON orders_details');
        $this->addSql('ALTER TABLE orders_details DROP orders_id, DROP disque_id');
